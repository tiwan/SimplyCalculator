...
I decided to add some more depth to my solution. That would be the implementation of setting order of mathematical operations.  In short: program has defined order of operators.
